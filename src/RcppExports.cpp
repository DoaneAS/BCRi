...
RcppExport SEXP _BCRi_pairwiseMutMatrixRcpp(SEXP informative_posSEXP, SEXP mutMtxSEXP, SEXP motifMtxSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_BCRi_pairwiseMutMatrixRcpp", (DL_FUNC) &_BCRi_pairwiseMutMatrixRcpp, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_BCRi(DllInfo *dll) {
