...
#' Bootstrap repartition metacommunity
#'
#' Performs bootstrap resampling on metacommunity data for diversity analysis.
#'
#' @param jdmat matrix of community data
#' @param aff_mat affinity matrix for genetic similarity
#' @param nboot number of bootstrap iterations
#' @param qs vector of q values for diversity calculation
#'
#' @return Returns bootstrap results for diversity analysis
#' @export
#'
